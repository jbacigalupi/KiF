...
new IGravity(0,0,0.1);  //instantiate gravity force

//IG.save("test_output_file.3dm"); // Saves initial geometry state, not desired final 'flock'

//int time = IG.time();
IG.p(IG.duration());

//if (IG.duration() >=50 && IG.duration() <= 100){IG.p("ping");}
...
//new IFieldVisualizer(-100,-100,-10, 100,100,10, 40,40,10);
